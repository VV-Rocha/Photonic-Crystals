...
from src.fields.oc_fields_2d import CoupledPhaseEncodingSingleFeatureGaussian2D
...
if Defocusing:
    base_dir = "./Data/EncodingProbe/Phase/Defocusing/"
else:
    base_dir = "./Data/EncodingProbe/Phase/Focusing/"


inheritance = {
    PlotCoupledFields2D,
    CoupledSplitStepSolver,
    CoupledPhaseEncodingSingleFeatureGaussian2D,
...
for i in range(64):
    ...
    simbox.field1 *= np.exp(1.j * random)
